...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BoardCell_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BoardCell_t qt_meta_stringdata_BoardCell = {
    {
QT_MOC_LITERAL(0, 0, 9), // "BoardCell"
...
QT_MOC_LITERAL(4, 21, 1) // "c"
    ...
    "BoardCell\0clicked\0\0r\0c"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_BoardCell[] = {
...
void BoardCell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (BoardCell::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BoardCell::clicked)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject BoardCell::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_BoardCell.data,
...
// SIGNAL 0
void BoardCell::clicked(int _t1, int _t2)
{
